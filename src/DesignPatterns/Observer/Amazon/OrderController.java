...
public class OrderController implements OrderPublisher {
...
//        }
//    }
    List<OrderPlaceSubscriber> orderPlaceSubscriberList = new ArrayList<>();

    @Override
    public void register(OrderPlaceSubscriber subscriber) {
        orderPlaceSubscriberList.add(subscriber);
    }

    @Override
    public void deregister(OrderPlaceSubscriber subscriber) {
        orderPlaceSubscriberList.remove(subscriber);
    }

    @Override
    public void handlePlaceOrder(String orderId) {
        for(OrderPlaceSubscriber subscriber: orderPlaceSubscriberList){
